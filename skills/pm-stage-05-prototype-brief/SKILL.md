...
6. **Print to PM:**
   ...
   Review the prototype brief, edit if needed, then:
     /pm-approve 05                  - approve and proceed
     /pm-stage-05-prototype-brief    - regenerate from scratch
     /pm-feedback 05                 - capture notes
   ```

...
**Status:** 🔲 **Not implemented** (planned). Lets teammates trial PM-OS where GitHub/git is
blocked, without breaking the existing GitHub install path. Tracked alongside the install
tooling (`install.sh`, `scripts/pm_os_*`).

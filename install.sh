...
usage() {
  ...
  echo "  ./install.sh --runtime claude --repo https://gitlab.example.com/org/pm-os.git --pm-user karan"
  echo ""
  echo "Offline install from a local directory or extracted zip:"
  echo "  ./install.sh --runtime claude --source /path/to/pm-os --pm-user karan"
  echo ""
  echo "Options:"
